...
import { FiscalCreateDto, FiscalUpdateDto } from './dto';

@ApiTags('Countries')
@ApiBearerAuth()
@Controller('loggrar/Account/Process/Fiscal')
export class FiscalController {
  constructor(private controllerService: FiscalService) {}
  @ApiOperation({ summary: 'Get fiscal periods for grid view.', description: 'Get fiscal periods for grid view.' })
  ...
  @ApiOperation({ summary: 'List of fiscal periods', description: 'Get all fiscal period' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Process OK.' })
  @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Unauthorized information.' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Bad request.' })
  @ApiResponse({ status: HttpStatus.UNAUTHORIZED, description: 'Unauthorized.' })
  ...
  @ApiOperation({ summary: 'Create a fiscal period', description: 'Create a new fiscal period' })
  ...
  @Auth({ roles: [ValidRoles.super, ValidRoles.system, ValidRoles.administrator, ValidRoles.basic] })
  @Post()
  async create(@Body() body: FiscalCreateDto): Promise<TypeResponse> {
    const record: any = await this.controllerService.fiscalCreate(body);
    return toBackResponse('Record created successfully');
  }

  @ApiOperation({ summary: 'Get a fiscal period', description: 'Get a fiscal period by your id' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Process OK.' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Bad request.' })
  @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Unauthorized information.' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Bad request.' })
  ...
  @ApiOperation({ summary: 'Update a fiscal period', description: 'Update a fiscal period by your id' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Process OK.' })
  @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Unauthorized information.' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Bad request.' })
  @ApiResponse({ status: HttpStatus.UNAUTHORIZED, description: 'Unauthorized.' })
  ...
  @Auth({ roles: [ValidRoles.super, ValidRoles.system, ValidRoles.administrator, ValidRoles.basic] })
  @Patch(':id')
  async update(@Param('id', ParseUUIDPipe) id: string, @Body() body: FiscalUpdateDto): Promise<TypeResponse> {
    const updateResult: any = await this.controllerService.update(id, body);
    return toBackResponse('Record updated successfully');
  }

  @ApiOperation({ summary: 'Delete a fiscal period', description: 'Delete a fiscal period by your id' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Process OK.' })
  @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Unauthorized information.' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Bad request.' })
  @ApiResponse({ status: HttpStatus.UNAUTHORIZED, description: 'Unauthorized.' })
