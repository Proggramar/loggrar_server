...
export class UserBranchesController {
  ...
  async all(): Promise<TypeResponse> {
    ...
    return toBackResponse('Records returned', { records: plainToInstance(UserBranches, data), meta });
  }
  ...
  async get(@Param('id', ParseUUIDPipe) id: string): Promise<TypeResponse> {
    ...
    return toBackResponse('Record returned', { records: plainToInstance(UserBranches, data) });
  }
